...
<div class="row">
        ...
        <div class="card gradient-1">
            <div class="card-body">
                ...
                <div class="d-inline-block">
                    <h2 class="text-white"><?php echo GetAllValue('purchases', 'total_item_price'); ?> TK</h2>
                </div>
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="card gradient-2">
            <div class="card-body">
                ...
                <div class="d-inline-block">
                    <h2 class="text-white"><?php echo GetAllValue('sales', 'sub_total'); ?> TK</h2>
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="card gradient-3">
            <div class="card-body">
                <h3 class="card-title text-white">Total Productes</h3>
                <div class="d-inline-block">
                    <h2 class="text-white"><?php echo SelectProductes($id); ?></h2>
                    <p class="text-white mb-0">Jan - March 2019</p>
                </div>
