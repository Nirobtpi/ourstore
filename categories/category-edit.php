                    ...
                    <div class="basic-form">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cat_name" class="form-control input-default" id="cat_name" value="<?php echo $cat_data['category_name'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat_slug">Category Slug</label>
                                <input type="text" name="cat_slug" class="form-control input-default" value="<?php echo $cat_data['category_slug'] ?>" id="cat_slug">
                            </div>
